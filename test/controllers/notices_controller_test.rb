...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { content: @notice.content, is_home: @notice.is_home, is_show: @notice.is_show, shop_id: @notice.shop_id } }, as: :json
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { content: @notice.content, is_home: @notice.is_home, is_show: @notice.is_show, shop_id: @notice.shop_id } }, as: :json
    assert_response 200
  end
